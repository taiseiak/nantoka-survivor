...
function game:load(args)
    ...
    self.bulletsImage:setFilter("nearest", "nearest")
    ...
    self.coinImage:setFilter("nearest", "nearest")
...
function game:draw()
    ...
    for _, bullet in ipairs(self.bullets) do
        love.graphics.draw(self.bulletsImage, bullet.pos.x - self.bulletsRadius, bullet.pos.y - self.bulletsRadius, 0,
            0.5,
            0.5)
    end
    -- プレイヤーのライフを表示
